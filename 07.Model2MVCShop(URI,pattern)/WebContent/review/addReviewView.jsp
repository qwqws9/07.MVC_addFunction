...
function fncAddBoard(){
	...
	document.detailForm.action='/review/addReview';
	...
	<tr>
		...
		<td background="/images/ct_ttl_img02.gif" width="100%" style="padding-left: 10px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="93%" class="ct_ttl01">상품평 등록</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="105">
						<input type="text" name="reviewTitle" class="ct_input_g" 
									style="width: 371px; height: 19px" maxLength="20">
					</td>
				</tr>
			</table>
		</td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
		<textarea rows="20" cols="50" name="reviewContent"></textarea>
